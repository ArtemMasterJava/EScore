...
public class MainActivity extends AppCompatActivity {
    ...
    void getReport(){
        ...
        final Call<Match> call = service.getMatchReport();

        call.enqueue(new Callback<Match>() {
            @Override
            public void onResponse(Response<Match> response, Retrofit retrofit) {

                try {
                    String league = response.body().league.getName();
